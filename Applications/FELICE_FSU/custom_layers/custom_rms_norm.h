...
public:
   ...
   */
  WIN_EXPORT CUSTOM_RMS_NORM_GAMMA_INIT(nntrainer::Initializer value =
...
public:
   ...
   */
  WIN_EXPORT const std::string getType() const override { return CustomRMSNormLayer::type; };
...
private:
  ...
  std::tuple<props::CUSTOM_RMS_NORM_GAMMA_INIT, nntrainer::props::Epsilon, props::SmartReply> rms_props;
};
